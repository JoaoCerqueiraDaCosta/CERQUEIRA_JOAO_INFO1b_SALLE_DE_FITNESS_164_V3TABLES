    ...
    if request.method == "GET":
        try:
            with DBconnection() as mc_afficher:
                strsql_genres_films_afficher_data = """SELECT * FROM t_membres"""
                if id_film_sel == 0:
...
def genres_films_afficher_data(valeur_id_film_selected_dict):
    ...
    try:
        ...
        strsql_film_selected = """SELECT * FROM t_membres"""

        strsql_genres_films_non_attribues = """SELECT * FROM t_coach"""

        strsql_genres_films_attribues = """SELECT * FROM t_membres"""
