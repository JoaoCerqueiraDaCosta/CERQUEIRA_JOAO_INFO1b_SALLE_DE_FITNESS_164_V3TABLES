...
from APP_FILMS_164.genres.gestion_genres_wtf_forms import FormWTFUpdateMembres
        ...
        try:
            with DBconnection() as mc_afficher:
                if order_by == "ASC" and id_genre_sel == 0:
                    strsql_genres_afficher = """SELECT * FROM t_coach"""
                    ...
                    strsql_genres_afficher = """SELECT * FROM t_coach where id_coach =%(value_id_genre_selected)s"""
...
def genre_update_wtf():
    ...
    try:
        ...
        if request.method == "POST" and form_update.submit.data:
            ...
            str_sql_id_genre = "SELECT * FROM t_coach " \
    ...
    try:
        ...
        if request.method == "GET":
            ...
            with DBconnection() as mydb_conn:
                ...
                # Opération sur la BD pour récupérer "id_genre" et "intitule_genre" de la "t_genre"
                str_sql_id_genre = "SELECT SELECT * FROM t_coach"
