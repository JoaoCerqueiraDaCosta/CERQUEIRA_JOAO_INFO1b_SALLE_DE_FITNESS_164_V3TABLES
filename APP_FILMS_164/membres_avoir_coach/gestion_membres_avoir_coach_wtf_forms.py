...
class FormWTFUpdatemembres_avoir_coach(FlaskForm):
    ...
    nom_genre_update_wtf = StringField("Insérer le membre et le coach ", validators=[Length(min=2, max=20, message="min 2 max 20"),
...
class FormWTFDeletemembres_avoir_coach(FlaskForm):
    ...
    """
    nom_genre_delete_wtf = StringField("Effacer le membre et le coach")
    submit_btn_del = SubmitField("Effacer le membre et le coach")
